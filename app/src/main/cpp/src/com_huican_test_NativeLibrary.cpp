/*C2JavaActivity*/
/*#include "../inc/com_huican_test_NativeLibrary.h"*/
#include <jni.h>
...
Java_com_huican_test_NativeLibrary_getDataFromNative(JNIEnv *env, jclass type){
...
Java_com_huican_test_NativeLibrary_transferDataToNative
  (JNIEnv *env, jclass type, jobject dataBean){
    jni_data_bean data_bean;
